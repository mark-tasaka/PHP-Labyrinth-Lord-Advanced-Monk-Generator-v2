...
function monkAbility ($level)
{
    ...
    if($level <= 3)
    {
        $message = "*Do not gain bonuses to hit/damage from STR or to AC from DEX.<br/>
                    *When fighting with bare hands, if an attack succeeds by 5 more than what is required to hit on a d20, the opponent is stunned for d6 rounds; plus, there is a base probability (d100) equal to the opponent's AC that the opponent is killed instantly.<br/>
    ...
    {
        $message = "*Do not gain bonuses to hit/damage from STR or to AC from DEX.<br/>
                    *When fighting with bare hands, if an attack succeeds by 5 more than what is required to hit on a d20, the opponent is stunned for d6 rounds; plus, there is<br/> a base probability (d100) equal to the opponent's AC that the opponent is killed instantly.<br/>
                    *Can only be surprised with 1 on a d6.<br/>
    ...
    {
        $message = "*Do not gain bonuses to hit/damage from STR or to AC from DEX.<br/>
                    *When fighting with bare hands, if an attack succeeds by 5 more than what is required to hit on a d20, the opponent is stunned for d6 rounds; plus, there is a base probability (d100) equal to the opponent's AC+"
                    . ($level - 7) . " that the opponent is killed instantly.<br/>
                    *Can only be surprised with 1 on a d6.<br/>
